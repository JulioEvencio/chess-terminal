...
public class UI {
    ...
    public static void printBoard(ChessPiece[][] chessPieces) {
        for (int i = 0; i < chessPieces.length; i++) {
            ...
            for (int j = 0; j < chessPieces.length; j++) {
                UI.printPiece(chessPieces[i][j], false);
            }
    ...
    public static void printBoard(ChessPiece[][] chessPieces, boolean[][] possibleMoves) {
        for (int i = 0; i < chessPieces.length; i++) {
            ...
            for (int j = 0; j < chessPieces.length; j++) {
                UI.printPiece(chessPieces[i][j], possibleMoves[i][j]);
            }
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        List<ChessPiece> whites = captured.stream().filter(color -> color.getColor() == Color.WHITE).toList();
        List<ChessPiece> blacks = captured.stream().filter(color -> color.getColor() == Color.BLACK).toList();
